...
const Chart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const jsonData = {
        original: {
          accessibility_score: 43.33,
          analysis: {
            color_contrast: {
              score: 50,
              details:
                "Text contrast against the background appears acceptable at first glance, but precise measurement is needed to confirm WCAG compliance.  A tool should be used to measure the contrast ratio.",
            },
            text_legibility: {
              score: 60,
              details:
                "Font size appears small.  While the font type is sans-serif (likely), it is hard to judge legibility without knowing the exact font and size.  Line spacing is minimal.",
            },
            alt_text: {
              score: 0,
              details:
                "Placeholder images 'Placeholder 1' and 'Placeholder 2' strongly suggest missing alt text.  Without alt text, these images are inaccessible to screen readers.",
            },
            interactive_elements: {
              score: 70,
              details:
                "Buttons and form fields are visible. However, the lack of visible hover and focus states makes interaction less clear, especially for users with motor impairments or those relying on keyboard navigation.",
            },
            visual_hierarchy: {
              score: 80,
              details:
                "The layout is relatively straightforward, with clear labeling of form fields.  However, there is no visual separation between sections, which could be improved.",
            },
            focus_indicators: {
              score: 0,
              details:
                "No visible focus indicators are present.  This is a critical accessibility failure, as keyboard-only users cannot determine which element has focus.",
            },
          },
          recommendations: [
